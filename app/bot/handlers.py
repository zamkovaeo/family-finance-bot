...
async def start(message: Message, command: CommandObject) -> None:
    ...
    await message.answer(
        ...
        "#отпуск — это тег: так можно помечать проекты и события, например #ремонт, #машина, #подарки.\n"
        "личное — операция только в вашем личном бюджете. семейное — общая операция семьи.\n"
        "Если не писать личное/семейное, расход считается личным.\n\n"
